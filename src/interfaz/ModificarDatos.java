...
public class ModificarDatos extends JFrame {
	...
	public  ModificarDatos() 
	{
		...
		lblNombre.setBounds(28, 95, 46, 14);
		contentPane.add(lblNombre);
		
		tfNombre = new JTextField();
		tfNombre.setBounds(170, 92, 215, 20);
		contentPane.add(tfNombre);
		tfNombre.setColumns(10);
		
		lblApellido = new JLabel("Apellido:");
		lblApellido.setBounds(28, 133, 46, 14);
		contentPane.add(lblApellido);	
		
		lblCedula = new JLabel("Cedula:");
		lblCedula.setBounds(28, 158, 46, 14);
		contentPane.add(lblCedula);
		
		tfCedula = new JTextField();
		tfCedula.setBounds(170, 155, 215, 20);
		contentPane.add(tfCedula);
		tfCedula.setColumns(10);
		
		lblFechaNac = new JLabel("Fecha de Nacimiento:");
		lblFechaNac.setBounds(28, 189, 144, 14);
		contentPane.add(lblFechaNac);
		
		tfFechaNac = new JTextField();
		tfFechaNac.setBounds(170, 186, 139, 20);
		contentPane.add(tfFechaNac);
		tfFechaNac.setColumns(10);
		
		lblSexo = new JLabel("Sexo:");
		lblSexo.setBounds(28, 220, 46, 14);
		contentPane.add(lblSexo);
		
		lblNombreDeUsuario = new JLabel("Nombre de Usuario:");
		lblNombreDeUsuario.setBounds(28, 256, 101, 14);
		contentPane.add(lblNombreDeUsuario);
		
		tfUsuario = new JTextField();
		tfUsuario.setBounds(170, 253, 177, 20);
		contentPane.add(tfUsuario);
		tfUsuario.setColumns(10);
		
		lblContrasea = new JLabel("Contrase\u00F1a:");
		lblContrasea.setBounds(28, 284, 86, 14);
		contentPane.add(lblContrasea);
		
		tfContraseña = new JTextField();
		tfContraseña.setBounds(170, 281, 215, 20);
		contentPane.add(tfContraseña);
		tfContraseña.setColumns(10);
		
	    comboSexo = new JComboBox();
		comboSexo.setBounds(170, 217, 139, 20);
		comboSexo.addItem("--------");
		...
		lblPreguntaDeSeguridad.setBounds(14, 312, 158, 14);
		contentPane.add(lblPreguntaDeSeguridad);
		
	    comboSeg = new JComboBox();
		comboSeg.setBounds(170, 309, 265, 20);
		comboSeg.addItem("---------");
		...
		lblRespuesta.setBounds(28, 352, 111, 14);
		contentPane.add(lblRespuesta);
		
		tfRespuesta = new JTextField();
		tfRespuesta.setBounds(170, 349, 185, 20);
		...
		btnRegistrar.addActionListener(new ActionListener() {
			...
			try {
				...
				p.modificar(tfNombre.getText(), tfApellido.getText(), sexo, tfCedula.getText(),
						tfUsuario.getText(), tfContraseña.getText(), comboSeg.getSelectedItem().toString(), tfRespuesta.getText());
		...
		btnRegistrar.setBounds(147, 394, 101, 23);
		...
		btnVolver.setBounds(258, 394, 89, 23);
		contentPane.add(btnVolver);
		
		tfApellido = new JTextField();
		tfApellido.setBounds(170, 124, 215, 20);
		contentPane.add(tfApellido);
		tfApellido.setColumns(10);
		
		JLabel lblElUnicoDato = DefaultComponentFactory.getInstance().createLabel("EL UNICO DATO NO MODIFICABLE EN \r\nEL PROGRAMA ");
		lblElUnicoDato.setFont(new Font("Times New Roman", Font.BOLD, 17));
		lblElUnicoDato.setBackground(Color.CYAN);
		lblElUnicoDato.setForeground(Color.RED);
		lblElUnicoDato.setBounds(53, 23, 468, 30);
		contentPane.add(lblElUnicoDato);
		
		JLabel lblEsLaCedula = DefaultComponentFactory.getInstance().createLabel("ES LA CEDULA");
		lblEsLaCedula.setBackground(Color.BLACK);
		lblEsLaCedula.setForeground(Color.RED);
		lblEsLaCedula.setFont(new Font("Times New Roman", Font.BOLD, 17));
		lblEsLaCedula.setBounds(214, 64, 144, 14);
		contentPane.add(lblEsLaCedula);
	}
}
